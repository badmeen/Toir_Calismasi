...
Public Class Login_Form1
    ...
    Private Sub Timer_Login_Tick(sender As Object, e As EventArgs) Handles Timer_Login.Tick
        Try
            If (Tools.Web_Licence2.Url.ToString().Contains(Tools.Encrypt2.Text + My.Computer.Name)) Then
                ...
                Dim ToirDirectory As IO.FileInfo
                ToirDirectory = My.Computer.FileSystem.GetFileInfo(My.Application.Info.DirectoryPath + "\LOADER.exe")
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Button1.Text = "Wait.."
        Sleep(2000)
        MsgBox("Redirect changed", MsgBoxStyle.Information, "")
        Button1.Text = "OK"
    End Sub
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Button2.Text = "Wait.."
        Sleep(2000)
        MsgBox("Inject Succesfully", MsgBoxStyle.Information, "")
        Button2.Text = "OK"
    End Sub
End Class
